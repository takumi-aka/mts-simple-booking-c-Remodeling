...
/**
 * MTS Simple Booking TOP画面に表示するカレンダーの処理モジュール
 *
 * @Filename	mtssb-top-calendar.php
 * @Date		2021-12-11
 * @Author		T.Suzuki
 *
 * Updated to 1.2.0 on 2012-12-22
 * Updated to 1.1.5 on 2012-12-02
 * Updated to 0.1.0 on 2021-12-11
 */
...
<?php
	...
	private function _reservation_of_the_day($thetime, $params) {
		...
		// 対象年月の予約者を読込む
		$this->cal= $this->get_booking_of_name($thetime, $article_id);
